export const simonSimonski = {
	name: 'Simon Simonski',
	sex: 'Hombre',
	occupation: 'Heredero de la Corporación Aeronáutica Simonski',
	hobby: 'Golf',
	hair: 'Rubio',
	vehicle: 'Jet privado',
	feature: 'Misterioso tatuaje eslavo en el hombro izquierdo',
	other: 'Él insiste que es Satoshi Nakamoto',
	clues: {
